                ...
                <div class="row align-items-center">
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info">
                            <ul>
                                <li>
                                    <button class="language-dropdown-active" style="border: none; background: transparent;"> 
                                        <i class="fi-rs-world"></i> English 
                                        <i class="fi-rs-angle-small-down"></i>
                                    </button>
                                    <ul class="language-dropdown">
                                        <li><a href="#"><img src="{{ asset('assets/imgs/theme/english.jpg') }}" alt="">English</a></li>
                                        <li><a href="#"><img src="{{ asset('assets/imgs/theme/Vietnam.svg') }}" alt="">Vietnamese</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block">
                                <ul>
                                    <li>Giảm giá tới 50% cho các thiết bị <a href="shop.html">Xem chi tiết</a></li>
                                    <li>Ưu đãi siêu giá trị - Tiết kiệm nhiều hơn với phiếu giảm giá</li>
                                    <li>Trang sức bạc 25 thời thượng, tiết kiệm tới 35% ngay hôm nay <a href="shop.html">Mua ngay</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.html">
                                                        <img alt="Surfside Media" src="{{ asset('assets/imgs/shop/thumbnail-3.jpg') }}">
                                                    </a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="product-details.html">
                                                        <img alt="Surfside Media" src="{{ asset('assets/imgs/shop/thumbnail-2.jpg') }}">
                                                    </a>
                                                </div>
                                                <div class="shopping-cart-title">
